...
/**
 * @generated from message vortyx.guard.v1.GetStatusRequest
 */
export class GetStatusRequest extends Message<GetStatusRequest> {
  ...
  static readonly typeName = "vortyx.guard.v1.GetStatusRequest";
...
/**
 * @generated from message vortyx.guard.v1.GetStatusResponse
 */
export class GetStatusResponse extends Message<GetStatusResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "vortyx.guard.v1.GetStatusResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
